...
namespace GuidanceLine
{
    ...
    public class GuidanceLine : MonoBehaviour
    {
        ...
        void InitializeLine()
        {
            ...
            activecheckPoint = (checkPoints == null || checkPoints.Length == 0) ? endPoint : checkPoints[0];
            DrawCurvedLine();
        }
        ...
        void Update()
        {
            ...
            activecheckPoint = (checkPoints != null && checkPoints.Length > 0) ? checkPoints[0] : endPoint;
            distanceToFirstCheckPoint = (checkPoints == null || checkPoints.Length == 0)
        ...
        {
            float distance;
            if (checkPoints == null || checkPoints.Length == 0)// handles the case where there is no more check points because we're at the endPoint
            {
